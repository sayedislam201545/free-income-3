...
let settingsContent = fs.readFileSync('admin_settings.txt', 'utf8');

// Also need AdminRequests, AdminVIP, AdminDeveloper!
...
const extraContent = fs.readFileSync('fix_admin_vip.cjs', 'utf8').split('`')[1];
