...
if (badIndex !== -1) {
    code = code.substring(0, badIndex); // Keep up to just before \n from "react";
}

// Ensure the file ends with AdsRewardsEditor's closing bracket, which it should.
// Let's add FeatureTogglesEditor!
